document.addEventListener('DOMContentLoaded', function() {
    ...
    function closeMenu(translateX) {
        ...
        if (c.contains('js_show_contentoverlay')) {
          c.remove('js_show_contentoverlay');
        }
        if (c.contains('overlay_mah')) {
          c.remove('overlay_mah');
        }
        if (c.contains('overlay_gs')) {
          c.remove('overlay_gs');
        }
        if (c.contains('overlay_both')) {
          c.remove('overlay_both');
        }
