...
# EG
options.pageTree.backgroundColor.34 = rgba(253, 196, 32, 0.1)
options.pageTree.backgroundColor.75 = rgba(253, 196, 32, 0.1)
# OG1
options.pageTree.backgroundColor.30 = rgba(234, 81, 96, 0.1)
# OG2
options.pageTree.backgroundColor.23 = rgba(16, 187, 239, 0.1)
# OG3
options.pageTree.backgroundColor.17 = rgba(147, 189, 85, 0.1)
